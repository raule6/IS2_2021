...
public class SegurosGUI extends JFrame {
	...
	public SegurosGUI() {
		...
		btnCalcular.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					txtPrecio.setText("¡Dato de entrada erróneo!");//txtPrecio.setText(Double.toString(precio));
					
				} catch (DateTimeParseException e) {
					txtPrecio.setText("Formato de fecha no válido");
				}
		...
		comboCobertura = new JComboBox<String>();
